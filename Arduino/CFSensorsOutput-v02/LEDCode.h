...
static uint8_t REDPIN = 13;
static uint8_t GREENPIN = 11;
static uint8_t BLUEPIN = 12;
static uint8_t ALPHAPIN = 10;
...
void LEDWrite(uint8_t rval, uint8_t gval, uint8_t bval, uint8_t aval) {
  ...
  analogWrite(ALPHAPIN, aval); // uncomment on waterproof led use
}
